...
export const NotesMachineCombinedStates = {
  ...
  addingNotesListsAddingNotes: { addingNotesLists: NotesMachineStates.addingNotes,},
  addingNotesListsChoosingNotesToCarry: { addingNotesLists: NotesMachineStates.choosingNotesToCarry,},
};
