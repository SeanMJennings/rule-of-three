...
import {
  ...
  hides_note_list_single_select_when_there_are_no_lists,
...
describe("Notes", () => {
  describe("Note List", () => {
    it(
      "asks user to create first note list",
      asks_user_to_create_first_note_list,
    );
    it(
      "hides note list single select when there are no lists",
      hides_note_list_single_select_when_there_are_no_lists,
    );
  ...
  describe("Notes", () => {
    ...
    it(
      "removes add first note placeholder on click",
      removes_add_first_note_placeholder_on_click,
    );
    it(
      "disables add note button when input is empty",
      disables_add_note_button_when_input_is_empty,
    );
    it("adds and lists a note", adds_and_lists_a_note);
    it(
      "shows note count if there are notes",
      shows_note_count_if_there_are_notes,
    );
    it(
      "limits note length to 150 characters",
      limits_note_length_to_150_characters,
    );
