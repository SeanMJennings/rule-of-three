  ...
  <div :class="styles.container">
    <div v-if="showAddTask(snapshot.value)" id="add-task" :class="styles.addTask">
      ...
      <div :class="commonStyle.inputContainer">
        ...
        <ButtonIcon title="Add task" :icon="faPlusSquare" :class="`${disabled() ? commonStyle.disabled : ''} ${commonStyle.addIcon}`" the_id="add-task-submit" v-on:click="submit()" :disabled="!_.isEqual(snapshot.value, TasksMachineCombinedStates.addingTasksListsAddingTasks)"/>
      </div>
